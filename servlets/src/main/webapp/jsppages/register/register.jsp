        ...
        <div class="post_block">
            <form name="regform" method="post">
                <table>
                    ...
                    <tr><td><common:localeTag key="first_name"/></td><td><input type="text" name="firstname"> </td></tr>
                    <tr><td><common:localeTag key="last_name"/></td><td><input  type="text" name="lastname"></td></tr>
                    <tr><td><common:localeTag key="nickname"/></td><td><input  type="text" name="nickname"></td></tr>
                    <tr><td><common:localeTag key="date_of_birth"/></td><td><input  type="date" name="dob"></td></tr>
                    ...
                    <tr></tr>
                    <tr><td></td><td> <a class="hvr-fade post_link" href="/auth/team_register">
                        <common:localeTag key="team_register"/>
                    </a></td></tr>
                </table>
            </form>
        </div>
